...
const ListItem = forwardRef(
  function ListItem(props: ListProps, ref: React.ForwardedRef<HTMLElement>): JSX.Element {
    const { todo, updateTodo, removeTodo, ...rest } = props
    return (
      <article ref={ref} {...rest} className="flex gap-4 py-4 px-4 border-b-gray-300 border-b">
        <button
